...
class ModelEvaluation:
    ...
    def evaluate(self):
        ...
        test_dataset = load_from_disk('artifacts/data_transformation/BBC/test_dataset')
        ...
        test_dataset[0:200], rouge_metric, model_t5, tokenizer, batch_size = 2, column_text = 'text', column_summary= 'summary'
            )
